<template>
    <div>
        ...
        <div class="max-box">
            ...
            <div class="box">
                <echart :option="sexOption" :height="350" />
            </div>
            <div class="box">
                <echart id="yuyuyu" :option="shuiqiuOptions" :height="350" />
            </div>
        </div>
    </div>
</template>
...
<script setup lang="ts">
    ...
    // reactive不同于ref的是 reactive能响应数组或者对象 toRefs配合watch使用
    import { handlePieCube } from './echart/pie3D';
    import { visitorData, visitorTimeData, shuiqiu } from './echart/echart-config';
...
<style scoped>
    ...
    .max-box {
        ...
        background-color: rgba(36, 201, 203, 0.2);
        width: 100%;
        display: flex;
